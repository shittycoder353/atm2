...
public class MyRadioConsumerApplication extends AbstractJoynrApplication {
    ...
    /**
     * Main method. This method is responsible for: 1. Instantiating the
     * consumer application. 2. Injecting the instance with Guice bindings 3.
     * Starting the application. 4. Ending the application so that the necessary
     * clean up calls are made.
     *
